...
#define KYBER_EQ 12
#define KYBER_POLYVECCOMPRESSEDBYTES (KYBER_K * 288)    /* u k*256*ep/8 */
...
#define KYBER_ETA1 2
#define KYBER_ETA2 2
#define KYBER_POLYCOMPRESSEDBYTES    128                /* v 256*eg/8 */
#elif KYBER_K == 4
#define KYBER_ETA1 2
#define KYBER_ETA2 2
...
/* 32 bytes of additional space to save ID(pk) */
#define PREFIXHASHBYTES 32
